...
class VolumeStrategy(bt.Strategy):
    ...
    def log(
        ...
        columns=["buy_date", "sell_date", "buy_price", "sale_price", "currency_id","run_name","status",
                "sell_price_multiple","buy_volume_multiple","volume_avg_duration","transparent"]
        """
    ...
    def __init__(self):
        ...
        self.RESULTS_FOLDER = Path("../bt_data_runs/").resolve()
        self.df_save_path = self.RESULTS_FOLDER.joinpath(f"_temp_df.pkl")
