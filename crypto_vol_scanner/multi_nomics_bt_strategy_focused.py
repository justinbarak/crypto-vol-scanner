...
class VolumeStrategy(bt.Strategy):
    ...
    params = (
        ("VolAvgLength", 20),
        ("TriggerPriceMultipliers", [20, 30, 40, 50, 60]),
        ("TriggerVolumeMultiplier", 6),
        ("OnlyTransparent", True),
        ("CurrencyID", "NONE"),
            ...
            self.log_df = self.log_df.append(
                {
                    ...
                    "buy_avg_volume_before_trigger": self.vol_avg[-1],
                },
                ignore_index=True,
                sort=False,
            )
